...
export default styled(TextField)(({ theme, ownerState, color }) => {
  ...
  const errorStyles = () => ({
    ...
    '& .MuiFormHelperText-root': { color: colorError.main },
  });

  const borderColorValue =
    borderColorForExpand === '#d2d6da'
      ? `1px solid ${borderColorForExpand}`
      : 'none';
