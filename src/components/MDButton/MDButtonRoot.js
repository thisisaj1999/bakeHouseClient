...
export default styled(Button)(({ theme, ownerState }) => {
  ...
  const { color, variant, size, circular, iconOnly, darkMode, fontFamily, fontSize } = ownerState;
  ...
  const gradientStyles = () => {
    ...
    const backgroundValue = color === 'white' || !gradients[color] ? white.main : color.main;
  ...
  return {
    ...
    ...(variant === 'circular' && circularStyles()),
